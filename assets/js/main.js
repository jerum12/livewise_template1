    ...
    (e.fn.sectionPosition = function (t, s) {
      e(this).each(function () {
        ...
        (a = Math.floor(l.height() / 2)),
          ...
          'top-half' === o
            ? (e(n).css('padding-bottom', r + a + 'px'), l.css('margin-top', '-' + a + 'px'))
            : 'bottom-half' === o &&
              (e(n).css('padding-top', i + a + 'px'), l.css('margin-bottom', '-' + a + 'px'));
      });
    });
        ...
        (a = c.attr(t)),
          ...
          'margin-top' === a
            ? (e(o).css('padding-bottom', l + u(n) + 'px'),
              c.css('margin-top', '-' + u(n) + 'px').css({ position: 'relative', 'z-index': '3' }))
            : 'margin-bottom' === a &&
  ...
  if (
    ...
    e('.filter-active').imagesLoaded(function () {
      if (e('.filter-active').length > 0) {
        var t = e('.filter-active').isotope({ itemSelector: '.filter-item', filter: '*' });
        ...
        if (
          (a.on('click', function (t) {
            ...
            a.addClass('active').siblings().removeClass('active'),
              s.sliderTab ? e(n).slick('slickGoTo', a.data('slide-go-to')) : r();
          }),
          s.sliderTab)
        ) {
